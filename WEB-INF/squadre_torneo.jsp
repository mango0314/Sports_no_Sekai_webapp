...
<head>
  <title>Squadre - Sports no Sekai</title>
  <meta charset="utf-8">
    ...
    <div class="row">
      ...
      <%
      	if(squadre != null && !squadre.isEmpty()){
      		for ( Squadra s : squadre){
      			String DettaglioSquadra = "DettaglioSquadra?id=" + s.getId() + "&torneo_id=" + s.getTorneo_id();
      ...
      %>
         ...
         <tbody>
                    ...
                    <img src="images/<%= s.getLogo() %>" alt=" Logo <%= s.getNome() %>" class="img-fluid mb-2"  style="max-height: 60px">
                     </a></td>
				      <td> <%= s.getNome() %>  </td>

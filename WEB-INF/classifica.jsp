...
<!-- Navigation-->
        ...
        <%  
      	...
      	int torneoId = (Integer) session.getAttribute("id");
        Torneo torneo = (Torneo) request.getAttribute("torneo");
      	int SportId = (Integer) request.getAttribute("sport_id");

        

      	String LogoTorneo = "LogoTornei?id=" + torneo;
      	String TorneoId = "DettaglioTorneo?id=" + torneo.getId() + "&sport_id=" + SportId;
        ...
        <%
      	if(classifica != null && !classifica.isEmpty()){
      		...
      		for ( Classifica c : classifica){
      			...
      			String TeamLogo = "LogoSquadra?id=" + c.getId_squadra();
      ...
      %>
                ...
                <tbody>
                  <tr>
                    ...
                    <img src="<%= TeamLogo %>" alt=" Logo <%= NomeTeam %>" class="img-fluid mb-2" >
                        <br> <%=   NomeTeam %> </a>
                     </td>

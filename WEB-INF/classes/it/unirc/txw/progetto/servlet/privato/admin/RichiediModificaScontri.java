 ...
 */
@WebServlet("/privato/RichiediModificaScontri")
public class RichiediModificaScontri extends HttpServlet {
	 ...
	 * Default constructor.
	 */
	public RichiediModificaScontri() {
...
// vedere se c'è il valore autenticato
		...
		int scontro_id = Integer.parseInt(idParam);
		...
		Scontro scontro = scontroDAO.getById(scontro_id);

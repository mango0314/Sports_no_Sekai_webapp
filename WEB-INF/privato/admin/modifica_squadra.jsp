...
<head>
  ...
  <title>Modifica <%= squadra.getNome() %> - Sports no Sekai</title>
  <meta charset="utf-8">
...
<body>
	...
	<% Vector<Giocatore> lista_giocatorisquadra = (Vector<Giocatore>) request.getAttribute("lista_giocatorisquadra"); %>
	

	<% 		int squadra_id = squadra.getId();
			String nomeSquadra= squadra.getNome();
			String logoSquadra= squadra.getLogo();
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        ...
        <form id="contactForm" method="post" action="ModificaSquadra">
         
            <input type="hidden" name="giocatori_count"
       value="<%= lista_giocatorisquadra != null 
                 ? lista_giocatorisquadra.size() 
                 : 0 %>"/>
       ...
       value="<%= nomeSquadra %>" placeholder="Nome squadra" required/>
		...
		<input type="radio" id="logo1" name="teamLogo" value="logo_1.png"
		<%= "logo_1.png".equals(logoSquadra) ? "checked" : "" %> required>
        ...
        <div class="col-6 col-md-4 col-lg-3 logo-option mb-3">
		<input type="radio" id="logo2" name="teamLogo" value="logo_2.png"
		<%= "logo_2.png".equals(logoSquadra) ? "checked" : "" %> required>
          <label for="logo2" class="card p-2 text-center">
            ...
            <div class="col-6 col-md-4 col-lg-3 logo-option mb-3">
			<input type="radio" id="logo3" name="teamLogo" value="logo_3.png"
			<%= "logo_3.png".equals(logoSquadra) ? "checked" : "" %> required>
          <label for="logo3" class="card p-2 text-center">
           ...
           <div class="col-6 col-md-4 col-lg-3 logo-option mb-3">        
			<input type="radio" id="logo4" name="teamLogo" value="logo_4.png"
			<%= "logo_4.png".equals(logoSquadra) ? "checked" : "" %> required>
        ...
        <div class="col-6 col-md-4 col-lg-3 logo-option mb-3">        
			<input type="radio" id="logo5" name="teamLogo" value="logo_5.png"
			<%= "logo_5.png".equals(logoSquadra) ? "checked" : "" %> required>
          <label for="logo4" class="card p-2 text-center">
        ...
        <div class="col-6 col-md-4 col-lg-3 logo-option mb-3">        
			<input type="radio" id="logo6" name="teamLogo" value="logo_6.png"
			<%= "logo_6.png".equals(logoSquadra) ? "checked" : "" %> required>
        ...
        <div class="col-6 col-md-4 col-lg-3 logo-option mb-3">        
			<input type="radio" id="logo7" name="teamLogo" value="logo_7.png"
			<%= "logo_7.png".equals(logoSquadra) ? "checked" : "" %> required>
        ...
        <div class="col-6 col-md-4 col-lg-3 logo-option mb-3">        
			<input type="radio" id="logo8" name="teamLogo" value="logo_8.png"
			<%= "logo_8.png".equals(logoSquadra) ? "checked" : "" %> required>
     ...
     <% if( lista_giocatorisquadra != null && !lista_giocatorisquadra.isEmpty()){ %> 
    ...
    <table class="table table-striped table-bordered">
      ...
      <tbody>
      <% for (int i = 0; i < lista_giocatorisquadra.size(); i++) {
    	  	Giocatore g = lista_giocatorisquadra.get(i);
    	  ...
    	  %>
            <tr>
              <th scope="row" class="text-white"><%= i+1 %></th>
				<td class="d-none">
                <input type="hidden" name="id_<%= i %>" value="<%= g.getId() %>"/>
              </td>             
               <td>
                <input type="text" name="nome_<%= i %>" value="<%= g.getNome() %>"
       ...
       title="Il nome non può contenere numeri o simboli speciali"
              ...
              <td>
                <input type="text" name="cognome_<%= i %>" value="<%= g.getCognome() %>"
                       class="form-control form-control-sm" 
                       pattern="[A-Za-zÀ-ÿ\s']+" 
       title="Il cognome non può contenere numeri o simboli speciali"
              ...
              <td>
                <input type="text" name="dataNascita_<%= i %>" value="<%= new java.text.SimpleDateFormat("dd/MM/yyyy").format(g.getDataDiNascita()) %>"
              ...
              <td>
                <select name="numeroMaglia_<%= i %>"
                  ...
                  <% for (int n = 1; n <= 99; n++) { %>
    				<option value="<%= n %>" <%= g.getNumero_di_maglia() == n ? "selected" : "" %>><%= n %></option>
                  <% } %>
                </select>

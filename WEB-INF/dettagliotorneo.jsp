...
<% 
	if(ultimo_scontro != null ){
		...
		String DettaglioSquadraCasa_ultimo = "DettaglioSquadra?id=" + ultimo_scontro.getSquadra1_id() + "&torneo_id=" + ultimo_scontro.getTorneo_id();
		String DettaglioSquadraTrasferta_ultimo = "DettaglioSquadra?id=" + ultimo_scontro.getSquadra2_id() + "&torneo_id=" + ultimo_scontro.getTorneo_id();
        ...
        <div class="col-lg-12">
          ...
          <div class="d-flex team-vs">
            ...
            <div class="team-1 w-50">
              ...
              <a href= "<%= DettaglioSquadraCasa_ultimo %>">
            ...
            <div class="team-2 w-50">
              <div class="team-details w-100 text-center">
              <a href= "<%= DettaglioSquadraTrasferta_ultimo %>">
            ...
            <div class="widget-body">
              <div class="widget-vs">
                <div class="d-flex align-items-center justify-content-around justify-content-between w-100">
                  ...
                  <a href = "<%= DettaglioSquadraTrasferta %>" <%= s.getSquadra2_id() %>>
